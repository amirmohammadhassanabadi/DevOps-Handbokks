...
```text
RollingUpdate
→ How Pods are gradually replaced

Canary
→ How a small portion of traffic/users receives the new version first

Blue-Green
→ How two complete environments are maintained and traffic is switched
  between them
```
